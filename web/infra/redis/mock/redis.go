...
func (m *MockRedisClientInterface) Subscribe(ctx context.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Subscribe", ctx)
}

// Subscribe indicates an expected call of Subscribe.
func (mr *MockRedisClientInterfaceMockRecorder) Subscribe(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Subscribe", reflect.TypeOf((*MockRedisClientInterface)(nil).Subscribe), ctx)
}
