...
func (mr *MockRedisClientInterfaceMockRecorder) Publish(ctx, channel, messages interface{}) *gomock.Call {
...
func (mr *MockRedisClientInterfaceMockRecorder) Subscribe(ctx, tm interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
