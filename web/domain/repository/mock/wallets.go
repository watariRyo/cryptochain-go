...
func (mr *MockWalletsInterfaceMockRecorder) CaluculateBalance(chain, address interface{}) *gomock.Call {
...
func (mr *MockWalletsInterfaceMockRecorder) ClearBlockChainTransactions(chain interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) CreateTransaction(recipient, amount, chain, tm interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) NewRewardTransaction(tm interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) SetMap(transactoinPool interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) SetTransaction(transaction interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) TransactionUpdate(senderWallet, recpient, amount, tm interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockWalletsInterfaceMockRecorder) ValidTransaction(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ValidTransactionData mocks base method.
func (m *MockWalletsInterface) ValidTransactionData(ctx context.Context, originalChain, chain []*model.Block) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidTransactionData", ctx, originalChain, chain)
	ret0, _ := ret[0].(bool)
	return ret0
}

// ValidTransactionData indicates an expected call of ValidTransactionData.
func (mr *MockWalletsInterfaceMockRecorder) ValidTransactionData(ctx, originalChain, chain interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidTransactionData", reflect.TypeOf((*MockWalletsInterface)(nil).ValidTransactionData), ctx, originalChain, chain)
}
...
func (mr *MockWalletsInterfaceMockRecorder) ValidTransactoins(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
